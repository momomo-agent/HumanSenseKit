...
#ifndef HUMANSENSEKIT_SWIFT_H
#define HUMANSENSEKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HumanSenseKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Receives buffers from STTManager via <code>processBuffer(_:)</code>.
SWIFT_CLASS("_TtC13HumanSenseKit21AudioDetectionManager")
@interface AudioDetectionManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13HumanSenseKit19FaceTrackingManager")
@interface FaceTrackingManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ARSession;
@class ARFrame;
@interface FaceTrackingManager (SWIFT_EXTENSION(HumanSenseKit)) <ARSessionDelegate>
- (void)session:(ARSession * _Nonnull)session didUpdateFrame:(ARFrame * _Nonnull)frame;
@end

SWIFT_CLASS("_TtC13HumanSenseKit18HandGestureManager")
@interface HandGestureManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13HumanSenseKit10STTManager")
@interface STTManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
